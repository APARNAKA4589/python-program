...
entry_Cookies=Entry(f1,font=("aria",20,"bold"),textvariable=lbl_Cookies,bd=6,width=8,bg="lightpink")
...
entry_Juice=Entry(f1,font=("aria",20,"bold"),textvariable=lbl_Juice,bd=6,width=8,bg="lightpink")
entry_Pancakes=Entry(f1,font=("aria",20,"bold"),textvariable=lbl_Pancakes,bd=6,width=8,bg="lightpink")
entry_Eggs=Entry(f1,font=("aria",20,"bold"),textvariable=lbl_Eggs,bd=6,width=8,bg="lightpink")
